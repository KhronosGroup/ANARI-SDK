...
function(anari_generate_debug_objects)
  if(CMAKE_VERSION VERSION_LESS "3.12")
    return()
  endif()
  ...
  add_custom_target(generate_${GENERATE_NAME}_debug_objects
  ...
  if (TARGET generate_all)
    add_dependencies(generate_all generate_${GENERATE_NAME}_debug_objects)
  endif()
endfunction()
