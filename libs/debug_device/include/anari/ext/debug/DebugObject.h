...
public:
  ...
  virtual void mapParameter(const char *name, ANARIDataType type, uint64_t elements, void *mem) = 0;
...
public:
  ...
  void mapParameter(const char *name, ANARIDataType type, uint64_t elements, void *mem) {
    uncommittedParameters += 1;
