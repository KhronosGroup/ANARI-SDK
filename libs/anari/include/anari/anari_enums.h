...
#define ANARI_KHR_AREA_LIGHTS "ANARI_KHR_AREA_LIGHTS"
#define ANARI_KHR_DEVICE_SYNCHRONIZATION "ANARI_KHR_DEVICE_SYNCHRONIZATION"
#define ANARI_KHR_FRAME_COMPLETION_CALLBACK "ANARI_KHR_FRAME_COMPLETION_CALLBACK"
#define ANARI_KHR_TRANSFORMATION_MOTION_BLUR "ANARI_KHR_TRANSFORMATION_MOTION_BLUR"
#define ANARI_KHR_AUXILIARY_BUFFERS "ANARI_KHR_AUXILIARY_BUFFERS"
#define ANARI_KHR_STOCHASTIC_RENDERING "ANARI_KHR_STOCHASTIC_RENDERING"

//
// An enum type that represensts the different data types represented in ANARI
//
#ifdef __cplusplus
...
#define ANARI_UNKNOWN ANARI_DATA_TYPE_DEFINE(9999999)

//
// ANARI wait mask values for get property
//
