...
ANARI_TYPEFOR_DEFINITION(char *);
ANARI_TYPEFOR_DEFINITION(const char *);
ANARI_TYPEFOR_DEFINITION(const char[]);
ANARI_TYPEFOR_DEFINITION(bool);
ANARI_TYPEFOR_DEFINITION(signed char);
ANARI_TYPEFOR_DEFINITION(unsigned char);
ANARI_TYPEFOR_DEFINITION(short);
ANARI_TYPEFOR_DEFINITION(unsigned short);
ANARI_TYPEFOR_DEFINITION(int);
ANARI_TYPEFOR_DEFINITION(unsigned int);
ANARI_TYPEFOR_DEFINITION(long);
ANARI_TYPEFOR_DEFINITION(unsigned long);
ANARI_TYPEFOR_DEFINITION(long long);
ANARI_TYPEFOR_DEFINITION(unsigned long long);
ANARI_TYPEFOR_DEFINITION(float);
ANARI_TYPEFOR_DEFINITION(double);

ANARI_TYPEFOR_DEFINITION(unsigned char[2]);
ANARI_TYPEFOR_DEFINITION(unsigned char[3]);
ANARI_TYPEFOR_DEFINITION(unsigned char[4]);
ANARI_TYPEFOR_DEFINITION(int[2]);
ANARI_TYPEFOR_DEFINITION(int[3]);
ANARI_TYPEFOR_DEFINITION(int[4]);
ANARI_TYPEFOR_DEFINITION(unsigned int[2]);
ANARI_TYPEFOR_DEFINITION(unsigned int[3]);
ANARI_TYPEFOR_DEFINITION(unsigned int[4]);
ANARI_TYPEFOR_DEFINITION(long long[2]);
ANARI_TYPEFOR_DEFINITION(long long[3]);
ANARI_TYPEFOR_DEFINITION(long long[4]);
ANARI_TYPEFOR_DEFINITION(unsigned long long[2]);
ANARI_TYPEFOR_DEFINITION(unsigned long long[3]);
ANARI_TYPEFOR_DEFINITION(unsigned long long[4]);
