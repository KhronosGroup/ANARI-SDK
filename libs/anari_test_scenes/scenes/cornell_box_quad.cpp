...
CornellBoxQuad::CornellBoxQuad(anari::Device d) : TestScene(d)
{
  m_world = anari::newObject<anari::World>(m_device);
}

CornellBoxQuad::~CornellBoxQuad()
{
  anari::release(m_device, m_world);
}

anari::World CornellBoxQuad::world()
{
  return m_world;
}
