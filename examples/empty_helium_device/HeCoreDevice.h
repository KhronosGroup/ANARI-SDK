...
struct HeCoreDevice : public helium::BaseDevice
{
  /////////////////////////////////////////////////////////////////////////////
  ...
  HeCoreDevice(ANARIStatusCallback defaultCallback, const void *userPtr);
  HeCoreDevice(ANARILibrary);
  ~HeCoreDevice() override;
