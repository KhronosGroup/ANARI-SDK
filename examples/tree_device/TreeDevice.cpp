...
// This file was generated by generate_device_frontend.py from templates/Device.cpp
    ...
    tree, subtype)
{
  if (subtype == std::string("default") || subtype == std::string("tree"))
    return (ANARIDevice) new anari::tree::TreeDevice();
  return nullptr;
}
