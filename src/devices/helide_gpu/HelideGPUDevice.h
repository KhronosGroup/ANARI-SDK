...
struct HelideGPUDevice : public helium::BaseDevice
{
  /////////////////////////////////////////////////////////////////////////////
  ...
  HelideGPUDevice(ANARIStatusCallback defaultCallback, const void *userPtr);
  HelideGPUDevice(ANARILibrary);
  ~HelideGPUDevice() override;
