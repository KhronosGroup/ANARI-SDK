...
any skip reason, timing, and relative image paths. The Python layer consumes
results purely by globbing this tree — it never renders and never opens a device.
